...
def args_parser():
    ...
    parser.add_argument('--dataset', type=str, default='cora', help="dataset name ('cora', 'citeseer').")
    parser.add_argument('--model',  type=str, default='gcn', help="model name ('gcn', 'median', 'trimmed').")
